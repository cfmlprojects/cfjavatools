...
<cffunction name="create" hint="Retrieves a reference to the java class. To create a instance, you must run init() on this object" access="public" returntype="any" output="false">
	...
	<cfscript>
		...
		{
			throwException("javaloader.ClassNotFoundException", "The requested class could not be found.", "The requested class '#arguments.className#' could not be found in classpath: #getClassloaderJars()#");
		}
	</cfscript>
</cffunction>
